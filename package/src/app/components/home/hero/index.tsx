          ...
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <motion.div
              ...
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                Nuerika is dedicated to helping startups solve the world’s toughest challenges. We craft tailored solutions and guide you from strategy to success, so you can stand out and win in a competitive market.
              </p>
            </motion.div>
